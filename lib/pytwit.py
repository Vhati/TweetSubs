...
class TwitterOAuthClient(oauth.OAuthClient):
  ...
  def __init__(self):
    ...
    self.VERIFY_CREDENTIALS_URL = "http://api.twitter.com/1/account/verify_credentials.json"

    self.HOME_TIMELINE_URL = "http://api.twitter.com/1/statuses/home_timeline.json"
    self.LOOKUP_USER_URL = "http://api.twitter.com/1/users/show.json"
    self.FOLLOW_USER_URL = "https://stream.twitter.com/1/statuses/filter.json"
    self.FOLLOW_SAMPLE_URL = "https://stream.twitter.com/1/statuses/sample.json"
    self.CONFIGURATION_URL = "http://api.twitter.com/1/help/configuration.json"
    self.SEND_TWEET_URL = "http://api.twitter.com/1/statuses/update.json"
